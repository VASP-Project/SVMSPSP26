...
import { FormDataModel, ProhibitedAuditSummary, ProhibitedItemAudit, ProhibitedItemForAudit } from '../concessionaire-security/concessionaire.model';
import { DataTableDirective } from 'angular-datatables';
import { FromTODate } from '@app/pages/inspectionrecord/inspectionrecord.model';
import { Subject } from 'rxjs';
import { Company } from '../company';
import { CompanyMasterService } from '../concessionaire-item-master/company-master.service';
import { AppConfigService } from '@app/_services/appconfigservice ';
import { NgxSpinnerService } from 'ngx-spinner';
import { ActivatedRoute, Router } from '@angular/router';
import { ToastrService } from 'ngx-toastr';
import { ModalDismissReasons, NgbCalendar, NgbDateAdapter, NgbDateStruct, NgbModal } from '@ng-bootstrap/ng-bootstrap';
import { InspectionrecordService } from '@app/pages/inspectionrecord/inspectionrecord.service';
import { DomSanitizer, SafeUrl } from '@angular/platform-browser';
import { use } from 'marked';

@Component({
  selector: "app-concessionaireauditlog",
  templateUrl: "./concessionaireauditlog.component.html",
  styleUrls: ["./concessionaireauditlog.component.scss"],
})

export class ConcessionaireauditlogComponent implements OnInit {
    ...
    this.dtOptions = {
      ...
      buttons: {
        buttons: [
          {
            extend: "csv",
            title: "Prohibited Audit Log", // customize title
            exportOptions: {
  ...
  @HostListener("window:resize", ["$event"])
    ...
    public GetProhibitedItemList() {
      ...
      this.companyMasterService
        .GetCompanyWiseAuditSummaryForAuthSigner(
          this.user.id,
  ...
  getItemStatus(dailyAuditId: number, modal: any) {
    ...
    getDailyItemsForAudit(logid, roleName, auditNo) {
      this.companyMasterService
        .GetDailyPohibitedItemForAuditForAuthsigner(logid, roleName, auditNo)
        .subscribe(
          (response: ProhibitedItemAudit[]) => {
            this.prohibitedItemList = response;
